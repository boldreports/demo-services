...
namespace ReportServices.Controllers.docs
{
    ...
    public class ExcelOptionsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public ExcelOptionsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
