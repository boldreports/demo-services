...
namespace ReportServices.Controllers.docs
{
    ...
    public class GetReportParametersController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public GetReportParametersController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        {
            var reportParameters = ReportHelper.GetParameters(jsonArray, this, this._cache);
