...
namespace ReportServices.Controllers.docs
{
    ...
    public class HtmlOptionsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public HtmlOptionsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
