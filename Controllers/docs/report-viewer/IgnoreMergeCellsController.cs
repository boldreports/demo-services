...
namespace ReportServices.Controllers.docs
{
    ...
    public class IgnoreMergeCellsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public IgnoreMergeCellsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
