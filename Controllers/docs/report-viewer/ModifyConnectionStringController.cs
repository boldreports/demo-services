...
namespace ReportServices.Controllers.docs
{
    ...
    public class ModifyConnectionStringController : ApiController, IReportController
    {
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            reportOption.ReportModel.DataSourceCredentials.Add(new BoldReports.Web.DataSourceCredentials("AdventureWorks", "demoreadonly@data-platform-demo", "N@c)=Y8s*1&dh", "Data Source=dataplatformdemodata.syncfusion.com;Initial Catalog=AdventureWorks;"));
