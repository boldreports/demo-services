...
namespace ReportServices.Controllers.docs
{
    ...
    public class ModifyConnectionStringController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public ModifyConnectionStringController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
