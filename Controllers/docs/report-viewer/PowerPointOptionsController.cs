...
namespace ReportServices.Controllers.docs
{
    ...
    public class PowerPointOptionsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public PowerPointOptionsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
