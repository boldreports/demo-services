...
namespace ReportServices.Controllers.docs
{
    ...
    public class PrintWithImagesController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public PrintWithImagesController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
