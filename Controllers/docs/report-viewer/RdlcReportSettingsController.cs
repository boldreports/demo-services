...
namespace ReportServices.Controllers.docs
{
    ...
    public class RdlcReportSettingsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public RdlcReportSettingsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            reportOption.ReportModel.ReportPath = this.basePath + @"/Resources/docs/product-list.rdlc";
