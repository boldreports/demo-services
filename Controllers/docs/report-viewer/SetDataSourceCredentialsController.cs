...
namespace ReportServices.Controllers.docs
{
    ...
    public class SetDataSourceCredentialsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public SetDataSourceCredentialsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
