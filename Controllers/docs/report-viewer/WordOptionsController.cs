...
namespace ReportServices.Controllers.docs
{
    ...
    public class WordOptionsController : Controller, IReportController
    {
        private Microsoft.Extensions.Caching.Memory.IMemoryCache _cache;
        private IWebHostEnvironment _hostingEnvironment;
        string basePath;

        public WordOptionsController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
